...
: # testing MySQL
: sqlsmith  --verbose --mysql="host=127.0.0.1 port=3306 dbname=test user=root password=password"
: # testing MySQL with only select statements
: sqlsmith  --verbose --mysql="host=127.0.0.1 port=3306 dbname=test user=root password=password" --select
check file queries.err.
...
| =--select=           | only simulate select(for mysql)                          |
